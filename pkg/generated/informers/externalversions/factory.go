...
import (
	...
	connectivity "github.com/vmware-tanzu/cross-cluster-connectivity/pkg/generated/informers/externalversions/connectivity"
...
func (f *sharedInformerFactory) Connectivity() connectivity.Interface {
	return connectivity.New(f, f.namespace, f.tweakListOptions)
}
